...
namespace MovementApp.Data
{
    public static class Defaults
    {
        ...
        public static string CHANGE_CONDITION = "api/movements/asset/setCondition";
        ...
        public static string REMOVE_MOVEMENT_ASSET = "api/movements/removeasset";
        public static string SUBMIT_MOVEMENT = "api/movements/submit";
        public static string SITES = "api/movements/locations";
        public static string ROOT_LOCATIONS = "api/movements/root/locations";
